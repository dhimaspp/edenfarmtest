...
class CustomSeparatorForm extends TextInputFormatter {
  final bool isNegative;
  final int decimalDigits;

  CustomSeparatorForm({this.decimalDigits = 2, this.isNegative = false})
  ...
  TextEditingValue formatEditUpdate(
    ...
    } else if (int.parse(newText) < 1 && isNegative == false) {
      return newValue.copyWith(text: '');
    }
